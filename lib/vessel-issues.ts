    ...
    issues: [
      {
        equipmentName: 'Main Crane System',
        category: 'crane',
        issue: 'Main hoist gearbox oil analysis warning',
        healthScore: 63,
        temperature: 78,
        vibration: 6.2,
        status: 'warning',
        pmPrediction: {
          predictedIssue: 'Gearbox bearing wear progressing',
          priority: 'high',
          warningSignals: [
            'Iron particle count elevated (85 ppm)',
            'Oil viscosity degraded',
            'Slight temperature increase in gearbox',
          ],
          recommendedAction: 'Gearbox inspection and oil change, plan bearing replacement',
          timeToFailure: '300 operating hours',
          confidence: 84,
        },
      },
